...
/******************* 
 Minified on Fri Apr 02 2021 09:07:28
*******************/ 

!function(a,b){"use strict";var c=function(a,c){this.elem=a,this.$elem=b(a),this.options=c};c.prototype={defaults:{link:document.URL,title:document.title,description:"",media:null,facebookID:null,facebook:!0,twitter:!0,pinterest:!0,googleplus:!0,linkedin:!0,position:"bottom",speed:100},init:function(){return this.config=b.extend({},this.defaults,this.options),this.wrapHideshare(),this},wrapHideshare:function(){var c=c,d=this.$elem.outerWidth(),e=this.$elem.outerHeight(),f=0,g=this.config.position,h=this.config.speed,i=this.config.title,j=this.config.link,k=this.config.media,l=this.config.description,m=this.config.facebookID,n='<li><a class="hideshare-google-plus" href="#"><i class="fa fa-google-plus-square fa-2x"></i><span>Google Plus</span></a><div class="google-plus-iframe"><div class="g-plusone" data-size="small" data-href="'+j+'" data-annotation="none"></div></div></li>';this.config.facebook?(c='<li><a class="hideshare-facebook" href="#"><i class="fa fa-facebook-square fa-2x"></i><span>Facebook</span></a></li>',f+=40):(c="",f=f),this.config.twitter?(c+='<li><a class="hideshare-twitter" href="#"><i class="fa fa-twitter-square fa-2x"></i><span>Twitter</span></a></li>',f+=40):(c=c,f=f),this.config.pinterest?(c+='<li><a class="hideshare-pinterest" href="#" data-pin-do="buttonPin" data-pin-config="above"><i class="fa fa-pinterest-square fa-2x"></i><span>Pinterest</span></a></li>',f+=40):(c=c,f=f),this.config.googleplus?(c+=n,f+=40,a.___gcfg={lang:this.config.lang},function(){var a=document.createElement("script");a.type="text/javascript",a.async=!0,a.src="https://apis.google.com/js/plusone.js";var b=document.getElementsByTagName("script")[0];b.parentNode.insertBefore(a,b)}()):(c=c,f=f),this.config.linkedin?(c+='<li><a class="hideshare-linkedin" href="#"><i class="fa fa-linkedin-square fa-2x"></i><span>Linked In</span></a></li>',f+=40):(c=c,f=f),f<d&&(f=d);var o='<ul class="hideshare-list" style="display: none; width: '+f+'px">'+c+"</ul>";this.$elem.addClass("hideshare-btn").wrap("<div class='hideshare-wrap' style='width:"+d+"px; height:"+e+"px;' />"),this.$wrap=this.$elem.parent(),b(o).insertAfter(this.$elem);var p=function(a,b,c,d,e){var f={};f="right"===a?{left:b+10+"px",right:-(b+10)+"px",opacity:"toggle"}:"left"===a?{left:-(b+10)+"px",right:b+10+"px",opacity:"toggle"}:"top"===a?{top:-(c+10)+"px",bottom:c+10+"px",opacity:"toggle"}:{top:c+10+"px",bottom:-(c+10)+"px",left:"0px",opacity:"toggle"},e.find(".hideshare-list").animate(f,d).addClass("shown")},q=function(a,b){var c={top:"0px",left:"0px",opacity:"toggle"};b.find(".hideshare-list").animate(c,a).removeClass("shown")};this.$elem.click(function(a){var c=b(a.currentTarget).parent();return c.find(".hideshare-list").hasClass("shown")?q(h,c):p(g,d,e,h,c),!1});var r=function(){a.open("//www.facebook.com/dialog/feed?display=popup&app_id="+m+"&redirect_uri="+encodeURIComponent(j)+"&link="+encodeURIComponent(j)+"&picture="+encodeURIComponent(k)+"&name="+encodeURIComponent(i)+"&descripcion="+encodeURIComponent(l),"Facebook","menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600")},s=function(){a.open("https://twitter.com/intent/tweet?original_referer="+encodeURIComponent(j)+"&text="+encodeURIComponent(i)+"%20"+encodeURIComponent(j),"Twitter","menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600")},t=function(){a.open("//pinterest.com/pin/create/button/?url="+encodeURIComponent(j)+"&media="+encodeURIComponent(k)+"&description="+encodeURIComponent(i),"Pinterest","menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600")},u=function(){a.open("//www.linkedin.com/shareArticle?mini=true&url="+encodeURIComponent(j)+"&title="+encodeURIComponent(i)+"&source="+encodeURIComponent(j),"LinkedIn","menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600")};this.$wrap.find(".hideshare-facebook").click(function(){return r(),!1}),this.$wrap.find(".hideshare-twitter").click(function(){return s(),!1}),this.$wrap.find(".hideshare-pinterest").click(function(){return t(),!1}),this.$wrap.find(".hideshare-linkedin").click(function(){return u(),!1})}},c.defaults=c.prototype.defaults,b.fn.hideshare=function(a){return this.each(function(){new c(this,a).init()})},a.Hideshare=c}(window,jQuery);
